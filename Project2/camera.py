...
class Camera:
    ...
    def __init__(self, viewport_size=(800,800), origin=glm.vec3(0, 0, 0), distance=10, xz_angle=np.radians(45), y_angle=np.radians(45),
    ...
    def get_view_matrix(self):
        if self.isPerspective:
            return glm.perspective(45, self.viewport_width/self.viewport_height, 0.1, 30) * glm.lookAt(self.camera_position(), self.origin, self.up)
        else:
            d = self.distance
