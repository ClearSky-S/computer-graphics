...
void main()
{
    gl_Position = vec4((vin_pos.x+u_color-0.5)*0.5, (vin_pos.y)*0.5, vin_pos.z, 1.0);
    vout_color = vec4(vin_color*u_color,1); // you can pass a vec3 and a scalar to vec4 constructor
}
'''
...
def main():
    ...
    u_position_loc = glGetUniformLocation(shader_program, 'u_position') # find uniform's location
