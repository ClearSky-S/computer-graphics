...
def main():
    ...
    arm = Node(base, glm.translate(glm.vec3(.2,0,0)), glm.translate((.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    arm2 = Node(arm, glm.translate(glm.vec3(0.5,0,0)), glm.translate((.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    arm3 = Node(base, glm.translate(glm.vec3(-.2, 0, 0)), glm.translate((-0.25, 0, .01)) * glm.scale((0.25, .1, 0.)),
               glm.vec3(1, 0, 0))
    arm4 = Node(arm3, glm.translate(glm.vec3(-0.5, 0, 0)), glm.translate((-0.25, 0, .01)) * glm.scale((0.25, .1, 0.)),
                glm.vec3(0, 1, 0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        draw_node(vao_box, arm3, P * V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, arm4, P * V, MVP_loc_box, color_loc_box)
